    ...
    with urlopen(url) as f:
        ...
        for i, senses in enumerate(meanings_listDict, start=1):
            ...
            for meaning in senses:
                ...
                defn_Dict = meaning.get('definitions',[])
                for all_defs in defn_Dict:
                    ...
                    if (len(synList) != 0):
                        ...
                        for s in synList:
                            all_syns_str += ', ' + s 
                        all_syns_str = all_syns_str[1:] # COULD HAVE USED .join(synList)
                    else:
                        all_syns_str = "NONE"
...
if __name__ == '__main__':
    ...
    #define('SYNONYM')
    #define('mouse', include_synonyms=True)
    #define('love', include_synonyms=True)
